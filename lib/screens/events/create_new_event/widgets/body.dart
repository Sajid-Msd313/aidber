...
class BodyNewCreateEvent extends GetView<CreateNewEventController> {
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomAuthTextFormField(hint: 'Organized By', labeltext: "Organized By", controller: controller.organizedByC, ),
            const SizedBox(height: 10),
            ...
            const SizedBox(height: 10),
            CustomMaxTextFormField(hint: 'Please Enter a Description', labeltext: "Description", controller: controller.descriptionC),
            const SizedBox(height: 10),
            CustomMaxTextFormField(hint: 'Expectation', labeltext: "What to Expect", controller: controller.whatToExpectC),
            const SizedBox(height: 20),
            Container(
              margin: const EdgeInsets.symmetric(vertical: 10, horizontal: 40),
              child: CustomButton(btnText: 'Create', primary: true, onPressed: () => controller.submit()),
            )
          ],
        ),
      ),
